        ...
        <aside class="sidebar-wrapper" data-simplebar="true">
          <div class="sidebar-header">
            ...
            <div>
              <h4 class="logo-text">Careplus</h4>
            </div>
          ...
          <ul class="metismenu" id="menu">
            <li>
              <a href="dashboard.jsp" class="has-arrow">
            ...
            <li>
              ...
              <ul>
                <li> <a href="addCategory.jsp"><i class="bi bi-arrow-right-short"></i>Add Category</a>
                </li>
                <li> <a href="viewCategory.jsp"><i class="bi bi-arrow-right-short"></i>View Category</a>
                </li>
              </ul>
            </li>
            <li>
